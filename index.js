...
var rayIntersectsSegment = function(p, p1, p2) {
  var a, b, mAB, mAP, ref;
...
var pointInPoly = function(p, poly) {
  var a, b, c, i, n;
  i = -1;
  n = poly.length;
  b = poly[n - 1];
...
var pointInSegmentBox = function(p, p1, q1) {
  var eps, px, py;
  eps = 1e-9;
  px = p[0];
	py = p[1];
...
var polyInsidePoly = function(polyA, polyB) {
...
var rotatePoint = function(p, alpha, origin) {
...
var rotatePoly = function(poly, alpha, origin) {
...
var intersectPoints = function(poly, origin, alpha) {
...
/**
	...
	@param poly Array of x, y coordinates describing a polygon
